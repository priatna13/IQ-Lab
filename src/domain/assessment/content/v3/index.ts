...
/** Published Content Version — original BI bank, psikotes-style item types. */
export const V3_CONTENT_VERSION_ID = "cv_mvp_v3";

/** Alias for the Content Version new Attempts should pin. */
export const CURRENT_CONTENT_VERSION_ID = V3_CONTENT_VERSION_ID;
...
export function getV3ContentVersion(): ContentVersion {
  const domains = buildDomains();
  return {
    id: V3_CONTENT_VERSION_ID,
    label: "IQ-Lab Konten v3",
    published: true,
